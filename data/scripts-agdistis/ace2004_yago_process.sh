...
#No Disambiguation
 python3 $AMSTEL_DIR/tagger_agdistis_fulldoc.py $INPUT_FILE ace2004_yago_neural_flair_ner_fast.tsv ner-fast false 1.0
#
...
# #Disambiguation 1.0
python3 $AMSTEL_DIR/tagger_agdistis_fulldoc.py $INPUT_FILE ace2004_yago_neural_flair_ner_fast_disambig_10.tsv ner-fast true 1.0
...
# #Disambiguation 0.8
python3 $AMSTEL_DIR/tagger_agdistis_fulldoc.py $INPUT_FILE ace2004_yago_neural_flair_ner_fast_disambig_08.tsv ner-fast true 0.8
...
head -n 2 ace2004_yago_neural_flair_ner_fast_disambig_08.metrics
